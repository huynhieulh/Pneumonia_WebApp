...
Original file is located at
    https://colab.research.google.com/drive/1y_pZ69S2nt49ka2TINzP4Y2Rdb003nWX
"""
...
model_14.compile(optimizer= keras.optimizers.Adam(lr=0.001), loss='binary_crossentropy', metrics=['accuracy'])



history = model_14.fit(x_train, y_train, epochs = 10, batch_size = 32, validation_data=(x_test, y_test) )
